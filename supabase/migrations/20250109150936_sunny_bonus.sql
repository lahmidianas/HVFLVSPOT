/*
  ...
  2. Details
    - Handles multi-word search terms properly
    - Uses websearch_to_tsquery for better parsing
    - Falls back to plainto_tsquery if needed
    - Maintains proper word relationships
*/
...
BEGIN
  ...
  -- First try websearch_to_tsquery
  BEGIN
